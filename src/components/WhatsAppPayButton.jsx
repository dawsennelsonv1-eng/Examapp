// src/components/WhatsAppPayButton.jsx
// Big, friendly WhatsApp-green payment button. Drop it ANYWHERE:
//   <WhatsAppPayButton planId="premium" />
// It opens WhatsApp with a prefilled message at the current (discounted) price.
// If no WhatsApp number is configured, it renders nothing (so it never shows a
// dead button).
...
export default function WhatsAppPayButton({
  planId = "premium",
  livePrice,
  className = "",
