...
// Sticky top header with logo, streak counter, and notification bell.
// Streak data comes from localStorage via useStreak hook.
...
export default function TopHeader() {
  ...
  // Mock notifications — later pulled from backend
  const notifications = [
    {
      id: 1,
