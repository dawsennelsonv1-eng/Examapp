...
// Final tab structure: Accueil · Quiz · [SCAN] · Classe · Réviser
// Classroom moved closer to center (high engagement), Réviser pushed to edge.
// Profile moved out of the tab bar — now lives in the top header as avatar.

import { NavLink, useNavigate, useLocation } from "react-router-dom";
import { motion } from "framer-motion";
import { Home, BookOpen, GraduationCap, Library, ScanLine } from "lucide-react";
...
export default function BottomTabBar() {
  ...
  const rightTabs = [
    { to: "/classe",  icon: GraduationCap, label: "Classe" },
    { to: "/reviser", icon: Library,       label: "Réviser" },
  ];
